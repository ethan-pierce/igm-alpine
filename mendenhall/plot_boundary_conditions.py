...
opti = Dataset('./basal-sliding/outputs/scalar_thkobs_std/optimize.nc')
geol = Dataset('./basal-sliding/outputs/scalar_thkobs_std/geology-optimized.nc')
...
plt.tight_layout()
plt.savefig('inversion_results.png', dpi = 400)
