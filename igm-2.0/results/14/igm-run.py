...
params.opti_velsurfobs_std         = 1.0                              # standard deviation of the velocity observations
params.opti_usurfobs_std           = 5.0                              # standard deviation of the surface elevation (if selected in controls)
params.opti_thkobs_std             = 50.0                             # standard deviation of the ice thickness (if selected in controls)
