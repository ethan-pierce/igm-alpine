...
params.opti_step_size             = 0.5        # control the step size of the optimization
...
params.opti_thkobs_std            = 15.0     # standard deviation of the ice thickness (if selected in controls)
